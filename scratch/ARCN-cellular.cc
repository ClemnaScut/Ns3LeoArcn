...
NS_LOG_COMPONENT_DEFINE("arcn-cellular");
...
ARCN::Configure(int argc, char* argv[])
{
    ...
    LogComponentEnable("arcn-cellular", LOG_LEVEL_ALL);
...
ARCN::Run() 
{
    ...
    SetupSocket();
    Simulator::Schedule(Seconds(3), &ARCN::NodeSendPacket, this);
...
ARCN::SetPosition()
{
    ...
    nodesPositionAlloc->Add (Vector(x*5, y*1, m_depth));
    nodesPositionAlloc->Add (Vector(x*2, y*2, m_depth));
    nodesPositionAlloc->Add (Vector(x*8, y*2, m_depth));
    nodesPositionAlloc->Add (Vector(x*5, y*3, m_depth));
    nodesPositionAlloc->Add (Vector(x*2, y*4, m_depth));
    nodesPositionAlloc->Add (Vector(x*8, y*4, m_depth));
    nodesPositionAlloc->Add (Vector(x*5, y*5, m_depth));


    //Set UanSink node's position
    nodesPositionAlloc->Add (Vector(x*4, y*0, m_depth));
    nodesPositionAlloc->Add (Vector(x*6, y*0, m_depth));

    nodesPositionAlloc->Add (Vector(x*1, y*1, m_depth));
    nodesPositionAlloc->Add (Vector(x*3, y*1, m_depth));
    nodesPositionAlloc->Add (Vector(x*7, y*1, m_depth));
    nodesPositionAlloc->Add (Vector(x*9, y*1, m_depth));

    nodesPositionAlloc->Add (Vector(x*0, y*2, m_depth));
    nodesPositionAlloc->Add (Vector(x*4, y*2, m_depth));
    nodesPositionAlloc->Add (Vector(x*6, y*2, m_depth));
    nodesPositionAlloc->Add (Vector(x*10, y*2, m_depth));

    nodesPositionAlloc->Add (Vector(x*1, y*3, m_depth));
    nodesPositionAlloc->Add (Vector(x*3, y*3, m_depth));   
    nodesPositionAlloc->Add (Vector(x*7, y*3, m_depth));
    nodesPositionAlloc->Add (Vector(x*9, y*3, m_depth));
    
    nodesPositionAlloc->Add (Vector(x*0, y*4, m_depth));
    nodesPositionAlloc->Add (Vector(x*4, y*4, m_depth));
    nodesPositionAlloc->Add (Vector(x*6, y*4, m_depth));
    nodesPositionAlloc->Add (Vector(x*10, y*4, m_depth));

    nodesPositionAlloc->Add (Vector(x*1, y*5, m_depth));
    nodesPositionAlloc->Add (Vector(x*3, y*5, m_depth));
    nodesPositionAlloc->Add (Vector(x*7, y*5, m_depth));
    nodesPositionAlloc->Add (Vector(x*9, y*5, m_depth));

    nodesPositionAlloc->Add (Vector(x*4, y*6, m_depth));
    nodesPositionAlloc->Add (Vector(x*6, y*6, m_depth));


    //Set Buoy node's position
    nodesPositionAlloc->Add (Vector(x*5, y*1, 0));
    nodesPositionAlloc->Add (Vector(x*2, y*2, 0));
    nodesPositionAlloc->Add (Vector(x*8, y*2, 0));
    nodesPositionAlloc->Add (Vector(x*5, y*3, 0));
    nodesPositionAlloc->Add (Vector(x*2, y*4, 0));
    nodesPositionAlloc->Add (Vector(x*8, y*4, 0));
    nodesPositionAlloc->Add (Vector(x*5, y*5, 0));
...
//			10000, 25000, 20000, 2, "Default mode");
    ...
    NS_LOG_DEBUG("the src0 mac address: " << uansrc_device.Get(0)->GetAddress());
